...
export default function Fornecedores() {
    ...
    return editModal ? (
        <EditFornecedorModal fornecedor={fornecedor || {id: "", nome: "", contato: "", endereco: ""}}
                             handleCloseEditModal={handleCloseEditModal}/>
    ) : createModal ? (
        <FornecedorModal handleCloseCreateModal={handleCloseCreateModal}/>
    ) : deleteModal ? (
        fornecedor ? (
            <DeleteModal handleDelete={() => handleDelete(fornecedor!)} fornecedor={fornecedor}
        ...
        <div>
            ...
            <div className="h-full flex flex-col ">
                ...
                <div className="flex-grow overflow-y-auto">
                    {fornecedores.map((fornecedor, index) => (
                        <div
                            ...
                            key={fornecedor.id}
                        >
                            <div onClick={() => handleOpenDetailsModal(fornecedor)}
                                 className="w-1/5 text-amber-600">{fornecedor.nome}</div>
                ...
                {detailsModalOpen && selectedFornecedor && (
                    <FornecedorDetailsModal fornecedor={selectedFornecedor}
