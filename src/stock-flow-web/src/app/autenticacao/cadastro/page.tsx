...
export default function Cadastro() {
    ...
    const makeRegister = async () => {
        const res: IAuthResponse = await RegisterUser({
    ...
    return (
        <>
            ...
            <section>
                <div className="overflow-y-scroll flex flex-col items-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                    <div className="flex items-center mb-6 text-2xl font-semibold text-indigo-900 dark:text-indigo-600">
                        <Image className="w-8 h-8 mr-2" src="/favicon.ico" alt="logo" width={80} height={80}/>
                        Stock Flow
                    </div>
                    <div
                            ...
                            <form className="space-y-4 md:space-y-6" onSubmit={handleRegister}>
                                ...
                                <div>
                                    ...
                                    <input type="password" name="passwordConfirm" id="passwordConfirm"
                                           ...
                                           onChange={(element) => setPasswordConfirm(element.target.value)}
                                           required={true}
                                           disabled={isLoading}
                                    />
                                </div>
                                ...
                                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                    Já possui uma conta? <a href="/autenticacao/login"
